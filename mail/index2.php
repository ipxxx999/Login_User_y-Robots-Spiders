...
$directory = $_SERVER['DOCUMENT_ROOT'] . '/robot/mail/';
...
<body>
<meta http-equiv="Content-Type"  content="text/html; charset=iso-8859-1" />
<h1>Registro de Hits por Robots P&#237;caros</h1>

<p>La siguiente es una lista de agentes de usuario que han ignorado este sitio. <em>robots.txt</em> archivo.
Tenga en cuenta que algunos de los llamados "aceleradores web" que simplemente pre-obtienen todos los enlaces en una p&#225;gina a un costo
 para su ancho de banda. el Robot tambi&#233;n ser&#225; atrapado por la trampa.</p>

<p><strong>Al hacer clic en la direcci&#243;n IP, aparecer&#225; m&#237;s informaci&#243;n sobre esa IP.</strong></p> 
