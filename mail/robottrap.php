...
$directory = $_SERVER['DOCUMENT_ROOT'] . '/mail/';
...
// Establish file path and name of the .htaccess file
// Establecer la ruta del archivo y el nombre del archivo .htaccess
$filename2 = $_SERVER['DOCUMENT_ROOT'] . '/mail/ANTI-ROBOTS.2htaccess';;
...
//  Append the IP address to the banned IP addresses section in the .htaccess file
//  Agregue la dirección IP a la sección de direcciones IP prohibidas en el archivo .htaccess
$fp = fopen ($filename2, 'a+'); 
fwrite ($fp, "Deny from $ipaddress\n"); 
fclose ($fp);

//  Send the mail message to say that a robot has been trapped.
//  Envía el mensaje de correo para decir que un robot ha sido atrapado.
$message  = "The following user agent has fallen into the robot trap: \n\n";
$message  = "  Date:           $date \n";
$message .= "  IP address:     $ipaddress \n";
$message .= "  Domain name:    $domainname \n";
$message .= "  User agent :    $useragent \n";
mail ($mailto, 'A Robot Has Been Trapped!', $message, $mailto);
