...
<select name="forma" onchange="location = this.value;">
    ...
    <option value="../visitas/index.php"> Lista - Visitantes - </option>
    <option value="../mail/robot2.php">Lista SPIDER ROBOTS</option>
</select>
...
<?php
				...
				?>
					...
					<tr>
						...
						<td><?php echo htmlentities($log["user"]); ?>: 1 <a href="http://whois.domaintools.com/<?php echo htmlentities($log["ip"]); ?>"  target=_blank><?php echo htmlentities($log["ip"]); ?></td>
						<td>Verificar: 2 <a href="https://ip.openadmintools.com/en/<?php echo htmlentities($log["ip"]); ?>"  target=_blank><?php echo htmlentities($log["ip"]); ?></td>
...
<div class="content">
<div class="who">Host: deals.ebay.com | *Block*</div>
<div class="what">¡Robot Spam Blacklist!</div>
            ...
            //now we're just waiting
                ...
                jQuery("#proof").css("opacity","0");
                        ...
                        setTimeout(function() {
                            ...
                            jQuery(".when").text(randoman + " Plugin Security System");
...
var items = Array(  "Host: 181.36.196.252 | *Block*",
                    "Host: 74.111.12.244 | *Block*",
                    "Host: 207.189.121.44 | *Block*",
                    "Host: 84.202.171.116 | *Block*",
                    "Host: amazonaws.com | *Block*",
                    "Host: 89.123.2.220 | *Block*",
                    "Host: adultpages.de | *Block*",
                    "Host: 83.234.189.197 | *Block*",
                    "Host: 121.166.82.1 | *Korea*",
                    "Host: 187.6.85.32 | *Brazil*",
                    "Host: 91.199.254.14 | *France*",
                    "Host: 110.54.131.249 | *Block*",
                    "Host: abiertitas.com | *Block*",
                    "Host: 88.199.92.130 | *Poland*",
                    "Host: 119.62.128.38 | *China*",
                    "Host: spynetwork.com | *Block*",
                    "Host: ssdsandbox.net | *Block*",
                    "Host: core.ignum.cz | *Block*",
                    "Host: 4-counter.com | *Block*",
                    "Host: 3menatwork.com | *Block*",
                    "Host: 2strong4.us | *Block*",
                    "Host: 181.36.196.252 | *Block*",
                    "Host: ads.box.sk | *Block*",
                    "Host: 181.36.196.252 | *Block*",
                    "Host: tvolymp.com | *Block*",
                    "Host: ad-where.com | *Block*",
                    "Host: 681.36.196.252 | *Block*",
                    "Host: yoyodyne.com | *Block*",
                    "Host: mchsi.com | *Block*",
                    "Host: 202.45.119.1 | *Block*",
                    "Host: 121.12.115.15 | *China*",
                    "Host: 181.36.196.252 | *Block*",
    );
