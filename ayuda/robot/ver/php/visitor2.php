...
$directory = $_SERVER['DOCUMENT_ROOT'] . '/robot/ver/php/';
...
<center> 
</p> <strong>Toca en Ver para Imprimir una visita </strong> <a href="visitor3.php">VER</a> </p> 

Luego Regresa a esta pagina y refresca la página.
