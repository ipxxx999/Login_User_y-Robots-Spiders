<?php	
	...
	defined("DB_SERVER")    	?	null	:	define("DB_SERVER", "PUEDES PONER (localhot) O ASI (fdb30.atspace.me) ok ");
	// El nombre de usuario de la cuenta que tiene acceso a la base de datos en el servidor MySQL / TuDB
	defined("DB_USER")			?	null	:	define("DB_USER", "USUARIO DE TU BASE DE DATO AQUI");
	// La contraseña (si la hubiera) asociada con la cuenta DB_USER
	defined("DB_PASS")			?	null	:	define("DB_PASS", "PASSWORD DE TU BASE DE DATOS AQUI");
	// El nombre de la base de datos (si importó el archivo sql.sql y no cambió ninguna configuración, entonces será logoip)
	defined("DB_NAME")			?	null	:	define("DB_NAME", "NOMBRE DE TU BASE DE DATOS AQUI");
	// La URL del sitio: la dirección que debe visitar para acceder al sistema
	defined("SITE_URL")			?	null	:	define("SITE_URL", "http://copen.atspace.tv/robot/");