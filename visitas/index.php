...
<title>Robot Spam Blacklist - User Agent Strings - List of Crawler - Lista negra de robots spam - y Cadena de agente usuario - Lista de rastreadores</title>
    ...
    <link rel="stylesheet" href="../css/clase_c.css">
...
<div class="c">
        <h2>Hola, <b><?php echo $udata['name'] ?></b>. Bienvenid@ a nuestro sistema.</h2>
        </div>
    </div>
    <p><center>
        <a href="../logout.php" class="btn btn-danger">Cierra la sesi&#243;n</a>
        <br><br><h2>Haga su selecci&#243;n para obtener m&#225;s Informaci&#243;n </a>

<select name="forma" onchange="location = this.value;">
    <option value="index.php">Seleccionar</option>
    <option value="../robot/index.php"> - SPIDER Babt Boot - </option>
    <option value="../visitas/visitor2.php">Visitas Sin Pantalla de impresión</option>
</select>
</center>
        </div>
    </div>
<p style="color: #000000; font-weight: bold; padding: 12px; border: 2px solid #000000; border-radius: 6px;"> <?php require_once("bandera.php");?> Localizar IP en un mapa </a>
...
<?php
				...
				// este es de la página lista de visitantes
				...
				?>
					...
					<tr>
						...
						<td>Verificar <a href="http://whois.domaintools.com/<?php echo htmlentities($log["ip"]); ?>"  target=_blank><?php echo htmlentities($log["ip"]); ?></td>
						<td>Postal Code: <a href="https://ip.openadmintools.com/en/<?php echo htmlentities($log["ip"]); ?>"  target=_blank><?php echo htmlentities($log["ip"]); ?></td>
...
<script type="text/javascript" src="./js/pkmwprds-core.js"></script>
...
<div id="proof" style="bottom: 10px; opacity: 1;">
<div class="datimage">
<img src="./png/user.png">
</div>
<div class="content">
<div class="who">Danny Yost | España</div>
<div class="what">¡Utiliza, Nuestro Sistema Gratis!</div>
<div class="when">53 minutos</div>
</div>
</div>
<script type="text/javascript">
function startTimeoutChain() { //Representa 1 ciclo de bucle // Represents 1 loop cycle

    setTimeout(function() {
        
        //tocar el tema
        //touch the theme
        jQuery("#proof").css("bottom","10px");
            ...
            //ahora solo estamos esperando
                ...
                jQuery("#proof").css("bottom","-100px");
                jQuery("#proof").css("opacity","0");

                        setTimeout(function() {
                            //make it appear opaque brahh
                            //haz que parezca opaco brahh
                            jQuery("#proof").css("opacity","1");

                            //change it up mate
                            //cámbialo amigo
                            var item = items[Math.floor(Math.random()*items.length)];

                            jQuery(".who").text(item);

                            randoman = Math.floor(Math.random() * 59);

                            jQuery(".when").text(randoman + " Script Security Plugin");

                        startTimeoutChain(); // Begin next loop // Comenzar el siguiente ciclo
                    }, 2000);
                }, 2000);
            }, 3000);
        }, 5000);
...
var items = Array(  "Rosa Villadiego | USA",
                    "Daniela Saldarriaga | Chile",
                    "Luisa Cataño | Colombia",
                    "Camila Gómez | Perú",
                    "Keile Martínez | Argentina",
                    "Alejandra Soto | Perú",
                    "Helena Grajales | México",
                    "Lola Padilla | Bolivia",
                    "Rossana Angulo | México",
                    "Ruben Castro | Colombia",
                    "Angela Jara | Venezuela",
                    "Roxanne Gann | Australia",
                    "Miguel Torres | Puerto Rico",
                    "Danny Yost | España",
                    "Julia Torres | Puerto Rico",
                    "Liliana Palacios | Honduras",
                    "Sandra Santos | Puerto Rico",
                    "Cristina Pérez | Panamá",
                    "Cristian Ortíz | Costa Rica",
                    "Tanya Krugger | Suiza",
                    "Manuela Mesa | El Salvador",
                    "Mayra Cervantes | Ecuador",
                    "Katherine Beltran | Paraguay",
                    "Carolina Villadiego | Colombia",
                    "Cindi Castro | México",
                    "Danelly Uran | Uruguay",
                    "Martha Arenas | México",
                    "Carlos Soto | Puerto Rico",
                    "Leidy Molina | Bolivia",
                    "Karen Martínez | USA ",
                    "Elizabeth Lopez | Argentina",
                    "Estefania Aya | Uruguay",
                    "Vivian Calderon | Portugal",
                    "Melynda Salo | Brasil",
                    "Alberto Manrique | Colombia",
                    "Ignaruz Rodríguez | Chile ",
                    "Lyndia Towner | Rusia",
                    "Salo Castro | Panamá",
                    "Luisa Santos | Puerto Rico",
                    "Sofia Laverde | México",
                    "Camilo Luna | Uruguay",
                    "Virginia Villani | Canada",
                    "Leila Blanco | Ecuador",
                    "Gina Díaz | Costa Rica",
                    "Grace Soto | Puerto Rico",
                    "Johanna Duarte | México",
                    "Jessica Zuluaga | España",
    );
