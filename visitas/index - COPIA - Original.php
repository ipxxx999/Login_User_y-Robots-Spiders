...
<style>
body  {
  background-image: url("./images/visitante.png");
...
<?php
				// Cerrar el bucle foreach una vez que se haya mostrado el elemento final en $ visitas
				};
					?>
				</tbody>
			</table>
