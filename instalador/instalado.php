...
<html>
<head>
<title>Galop&iacute;n v2.0 beta</title>
    <link rel="shortcut icon" href="../instalador/images/favicon.png">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table width="761" height="588" border="0" align="center" background="images/yaexiste.jpg">
  <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><form name="form1" method="post" action="salir.php">
        <div align="center">
